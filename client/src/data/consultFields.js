...
// type of LeGaL response to helpline inquiry
export const DISPO_NO_ANSWER = 'No answer'
export const DISPO_EMAIL_FOLLOWUP = 'Sent follow-up email'
export const DISPO_VOICEMAIL = 'Left voicemail'
export const DISPO_SPOKEN = 'Spoke with inquirer'
