...
```
## Create React App 2 and 3

Create React App 2.0 has changed how we will need to define our proxies in the next lecture. (This note and all steps and code contained also applies to the newly released v3.0)
